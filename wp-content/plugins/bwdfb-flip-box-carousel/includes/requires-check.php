...
function bwdfb_flip_box_register_required_plugins() {
	...
	if (bwdfb_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>BWD Flip Box Carousel</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>BWD Flip Box Carousel</b> requires Elementor to be installed and activated.</p>';
...
function bwdfb_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>BWD Flip Box Carousel</b> does not work since you are using an older version of Elementor</p>';
